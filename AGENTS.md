...
- **Agent Hub** — `/agent-hub` 统一管理 Claude/Codex/OpenCode/Grok Build/Gemini CLI/Cursor CLI 用户级与项目级指令（公共/适配/独有三槽 + AI 辅助修订）与 Skill/Command/Agent/MCP 可移植资产；身份目录见 `src-tauri/src/agent_catalog`
