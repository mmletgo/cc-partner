...
- **工作台** — 指定项目文件夹，管理 Git worktree、多个本机项目终端、可交互工作区文件树和 Git 提交树
...
│   │   │   ├── Workbench/        # 项目文件夹 + 多项目终端 + 文件树 + Git 提交树
...
| `web/src/pages/*` | 页面 | 高 |
| `web/src/pages/Workbench/*` | 工作台页面（三栏、worktree 管理、多终端、工作区文件树、Git 提交树） | 高 |
