...
2. macOS screen recording / accessibility / input monitoring / notification dialogs (grant, deny, retry), including fixed-certificate input monitoring upgrade retention (`L3-MACOS-INPUT-MONITORING-INTERNAL-001`)
