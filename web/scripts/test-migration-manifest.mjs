...
export const TEST_MIGRATION_MANIFEST = [
  { path: 'src/api/mobile.test.ts', runner: 'vitest' },
  { path: 'src/api/orchestrator.test.ts', runner: 'vitest' },
  { path: 'src/api/promptOptimizer.test.ts', runner: 'vitest' },
  { path: 'src/api/workbenchHttp.test.ts', runner: 'vitest' },
  { path: 'src/components/domain/MobileAccessCard/mobileAccessCard.test.ts', runner: 'vitest' },
  { path: 'src/components/domain/WorkbenchCodeEditor/workbenchCodeEditorTheme.test.ts', runner: 'vitest' },
  { path: 'src/components/domain/WorkbenchHtmlPreview/htmlAssets.test.ts', runner: 'vitest' },
  { path: 'src/components/domain/WorkbenchProjectRail/projectSessionStats.test.ts', runner: 'vitest' },
  { path: 'src/components/domain/WorkbenchProjectRail/workbenchProjectRailStyles.test.ts', runner: 'vitest' },
  { path: 'src/components/domain/WorkbenchRemoteProjectPicker/workbenchRemoteProjectPickerLayout.test.ts', runner: 'vitest' },
  { path: 'src/hooks/workbenchHttpEvents.test.ts', runner: 'vitest' },
  { path: 'src/hooks/workbenchTerminalBuffer.test.ts', runner: 'vitest' },
  { path: 'src/lib/backendLifecycle.test.ts', runner: 'vitest' },
  { path: 'src/lib/claudeCodeAssets.test.ts', runner: 'vitest' },
  { path: 'src/lib/lanFirewallDependency.test.ts', runner: 'vitest' },
  { path: 'src/lib/orchestrator.test.ts', runner: 'vitest' },
  { path: 'src/lib/orchestratorRemote.test.ts', runner: 'vitest' },
  { path: 'src/lib/permissionEntries.test.ts', runner: 'vitest' },
  { path: 'src/lib/platform.test.ts', runner: 'vitest' },
  { path: 'src/lib/workbenchDependency.test.ts', runner: 'vitest' },
  { path: 'src/mobile/MobileAutomationPanel.test.ts', runner: 'vitest' },
  { path: 'src/mobile/MobileWorktreeQuickSwitch.test.ts', runner: 'vitest' },
  { path: 'src/mobile/mobileBrowserPanel.test.ts', runner: 'vitest' },
  { path: 'src/mobile/mobilePanelState.test.ts', runner: 'vitest' },
  { path: 'src/mobile/mobileTerminalReplay.test.ts', runner: 'vitest' },
  { path: 'src/mobile/mobileTerminalTouchScroll.test.ts', runner: 'vitest' },
  { path: 'src/mobile/mobileWorkbenchState.test.ts', runner: 'vitest' },
