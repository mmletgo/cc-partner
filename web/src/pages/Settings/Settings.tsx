...
export function Settings() {
  ...
  // checking/downloading/installing 时轮询状态，每 800ms 一次；进入终态后停止。
  // 仅依赖 shouldPoll 布尔值，避免 progress 变化反复重建 interval。
  const shouldPollUpdates = shouldPollUpdateStatus(downloadStatus);
  useEffect(() => {
