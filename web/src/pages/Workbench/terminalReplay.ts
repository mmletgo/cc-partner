import {
  ...
  type TerminalBufferWriteMode,
  type TerminalBufferWritePlan,
} from '@/lib/terminalBufferDiff';

// Business Logic: 纯函数已抽到 neutral lib 层，供桌面 store 与移动 replay 共享；此处 re-export 保持现有导入路径不变。
export { planTerminalBufferWrite, type TerminalBufferWriteMode, type TerminalBufferWritePlan };
