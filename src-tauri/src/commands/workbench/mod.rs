...
pub use sessions::{
    ...
    __cmd__split_workbench_pane, __cmd__switch_workbench_pane,
    ...
    __tauri_command_name_search_claude_sessions, __tauri_command_name_split_workbench_pane,
    __tauri_command_name_switch_workbench_pane, __tauri_command_name_write_workbench_session_input,
    __tauri_command_name_zoom_workbench_pane, close_workbench_pane, close_workbench_session,
    ...
    resume_claude_session, search_claude_sessions, split_workbench_pane, switch_workbench_pane,
...
pub(crate) use sessions::{
    ...
    local_create_workbench_session, local_create_workbench_session_with_preallocated_ids,
    local_delete_workbench_path, local_focus_workbench_session, local_get_workbench_path_info,
    local_list_workbench_dir, local_rename_workbench_path, local_rename_workbench_session,
    local_resize_workbench_session, local_split_workbench_pane, local_switch_workbench_pane,
